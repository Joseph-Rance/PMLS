...
train_inputs = torch.cat(train_inputs, dim=0).reshape((112_800, 1, 28, 28))
train_labels = torch.tensor(train_labels)
test_inputs = torch.cat(test_inputs, dim=0).reshape((18_800, 1, 28, 28))
...
scheduler = CosineAnnealingLR(optimiser, T_max=TRAINING_EPOCHS*ceil(len(train_inputs)/BATCH_SIZE))
